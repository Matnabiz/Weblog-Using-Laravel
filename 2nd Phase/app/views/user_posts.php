...
<html lang="en">
    ...
    <body>
        ...
        <a class="button3" href="../controllers/logout.php" style="--color: #FA8072;">
            <span></span>
            <span></span>
            <span></span>
            <span></span>
        ...
        if (empty($posts))
            ...
            foreach ($posts as $post) {
                if ($post['username'] == $_SESSION['username']) {
                    ...
                    echo '<p class="timestamp"> by ' . htmlspecialchars($post['username']) . ' at ' . htmlspecialchars($post['reg_date']) . '</p>';
                    echo '<p>' . nl2br(htmlspecialchars($post['content'])) . '</p>';
                    echo "<p>Tags: " . $post['tags'] . "</p>";
                    echo '<div class="actions">';
                    echo '<a href="edit_post.php?title=' . urlencode($post['title']) . '">Edit Post</a>';
                    echo '<a href="../controllers/DeletePostController.php?id=' . urlencode($post['id']) . '" onclick="return confirm(\'Are you sure you want to delete this post?\');">Delete Post</a>';
                    echo '</div>';
                    echo '</div>';
                    $user_post_count ++;
                }
